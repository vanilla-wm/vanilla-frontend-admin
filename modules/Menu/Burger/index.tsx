...
import { Menu, Links, User, UserInfo } from './index.styled'
...
export default ({ asPath, username }) => {
  ...
  return (
    <Item right mobile>
      ...
      {isOpened && (
        <Menu onClick={() => setOpened(!isOpened)}>
          <Links>
            <Link href="/transactions">
              <Button as="a" tertiary isActive={asPath === '/transactions'}>
                Transactions
              </Button>
            </Link>
            <Link href="/analytics">
              <Button as="a" tertiary isActive={asPath === '/analytics'}>
                Analytics
              </Button>
            </Link>
          </Links>
